...
export type PrefetchInfiniteOptions = Pick<
  FetchInfiniteQueryOptions,
  'queryKey' | 'queryFn' | 'initialPageParam'
>;

export const isPrefetchOptions = (
  option: PrefetchOptions | PrefetchInfiniteOptions,
): option is FetchQueryOptions => {
  return (
    'queryKey' in option &&
    'queryFn' in option &&
    !('initialPageParam' in option)
  );
};
...
export const isPrefetchInfiniteOptions = (
  ...
  return (
    'queryKey' in option && 'queryFn' in option && 'initialPageParam' in option
  );
};

export type BasicSuspenseQueryOptions<T> = Pick<
  UseSuspenseQueryOptions<T>,
  'queryKey' | 'queryFn'
>;
export type BasicQueryOptions<T> = Pick<
  UseQueryOptions<T>,
  'queryKey' | 'queryFn'
>;
