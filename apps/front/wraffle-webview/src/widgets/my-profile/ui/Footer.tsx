...
const Footer = () => {
  return (
    <div className='inline-flex w-full flex-col gap-8 bg-zinc-100 pb-20 pt-8'>
      <div>
        <Icon name='social-instagram' />
      </div>

      <div className='flex flex-col gap-3'>
        <Typography size='h6' color='zinc500' className='font-bold'>
          고객센터
        </Typography>
        <Typography size='h6' color='zinc500' className='font-normal'>
          전화 : 02-123-1234 <br />
      ...
      <div className='flex flex-col gap-2'>
        ...
        <Typography size='p4' color='zinc400' className='font-normal'>
