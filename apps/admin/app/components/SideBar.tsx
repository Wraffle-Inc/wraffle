  ...
  return (
    <div className='flex h-full w-full flex-col space-y-10 bg-[#F3F4F6] p-8'>
      ...
      <div className='flex w-full flex-col gap-y-4'>
        <SideBarTab>회원 관리</SideBarTab>
        <SideBarTab>정산 관리</SideBarTab>
        <SideBarTab>래플/이벤트 관리</SideBarTab>
        <SideBarTab>카테고리 관리</SideBarTab>
        <SideBarTab>푸시 알림 관리</SideBarTab>
        <SideBarTab>추천 검색어 관리</SideBarTab>
        <SideBarTab>공지사항 관리</SideBarTab>
        <SideBarTab>메인 페이지 관리</SideBarTab>
      </div>
    </div>
  );
}
