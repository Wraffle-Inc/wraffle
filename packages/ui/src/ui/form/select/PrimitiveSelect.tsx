...
>(({className, children, ...props}, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <CaretDownIcon className='h-6 w-6 stroke-current stroke-[0.7px] text-[#8D9092]' />
