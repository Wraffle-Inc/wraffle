const IconLoader = (
  <svg xmlns='http://www.w3.org/2000/svg' style={{display: 'none'}}>
    ...
    <symbol id='divider-large' viewBox='0 0 2 32'>
      <path stroke='currentColor' d='M1 0v32' />
    </symbol>
    ...
    <symbol id='social-instagram' viewBox='0 0 36 36'>
      <path
        fill='#9CA3AF'
        fillRule='evenodd'
        d='M18.473 3c3.645 0 4.175.02 5.712.09 1.596.074 2.686.327 3.64.698a7.354 7.354 0 0 1 2.658 1.729 7.352 7.352 0 0 1 1.73 2.658c.37.954.623 2.044.697 3.64.072 1.601.09 2.111.09 6.185v.12c0 3.964-.018 4.48-.09 6.064-.073 1.596-.327 2.687-.697 3.641a7.353 7.353 0 0 1-1.73 2.658 7.353 7.353 0 0 1-2.658 1.73c-.954.37-2.044.623-3.64.697-1.601.072-2.111.09-6.185.09h-.12c-3.964 0-4.48-.018-6.064-.09-1.597-.073-2.687-.327-3.641-.697a7.352 7.352 0 0 1-2.658-1.73 7.354 7.354 0 0 1-1.73-2.658c-.37-.954-.623-2.044-.697-3.64-.07-1.537-.09-2.069-.09-5.712v-.945c0-3.645.02-4.176.09-5.712.074-1.597.327-2.687.698-3.641a7.353 7.353 0 0 1 1.729-2.658 7.353 7.353 0 0 1 2.658-1.73c.954-.37 2.044-.623 3.64-.697 1.537-.07 2.069-.09 5.713-.09h.945zm-.122 2.703h-.702c-3.684 0-4.176.016-5.71.087-1.463.067-2.257.31-2.786.516-.7.273-1.2.597-1.725 1.122a4.656 4.656 0 0 0-1.122 1.725c-.205.53-.45 1.323-.516 2.785-.07 1.535-.087 2.027-.087 5.711v.702c0 3.684.016 4.176.087 5.71.067 1.463.31 2.256.516 2.786a4.68 4.68 0 0 0 1.122 1.725 4.656 4.656 0 0 0 1.725 1.122c.53.206 1.323.45 2.785.516 1.582.072 2.055.087 6.062.087h.12c3.895 0 4.375-.015 5.94-.087 1.464-.068 2.258-.31 2.787-.516a4.668 4.668 0 0 0 1.725-1.122 4.656 4.656 0 0 0 1.122-1.725c.206-.53.45-1.323.516-2.786.072-1.582.087-2.055.087-6.061v-.12c0-3.895-.015-4.375-.087-5.94-.068-1.464-.31-2.258-.516-2.787a4.644 4.644 0 0 0-1.122-1.725 4.647 4.647 0 0 0-1.725-1.122c-.53-.205-1.323-.45-2.786-.516-1.534-.07-2.026-.087-5.71-.087zM18 10.297a7.702 7.702 0 1 1 0 15.405 7.702 7.702 0 0 1 0-15.405zm0 2.704A5 5 0 1 0 18 23a5 5 0 0 0 0-10zm8.007-4.808a1.8 1.8 0 1 1 0 3.6 1.8 1.8 0 0 1 0-3.6z'
        clipRule='evenodd'
      />
    </symbol>
  </svg>
